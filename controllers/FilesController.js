...
class FilesController {
  // retrieve user base on the token stored in redis
  ...
  // mark a as file public if user is authenticated
  ...
  // mark a as file private if user is authenticated
  ...
  // retrieve a file if it is public || of the request has been made by file owner
